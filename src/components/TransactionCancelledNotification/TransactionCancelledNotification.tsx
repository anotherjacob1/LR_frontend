...
import { ReactComponent as CancelledIcon } from 'assets/svg/NotificationCancelledIcon.svg';
...
const TransactionCancelledNotification: React.FC<TransactionsNotificationProps> =
  ({ description, hash, chainId }) => {
    ...
    return (
      <Box className={classes.root}>
        <CancelledIcon fill='url(#xpremiaRed)' />
...
export default TransactionCancelledNotification;
