...
import { ReactComponent as CancelledIcon } from 'assets/svg/NotificationFailedIcon.svg';
...
const TransactionFailedNotification: React.FC<TransactionsNotificationProps> =
